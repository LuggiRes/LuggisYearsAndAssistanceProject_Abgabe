    ...
    public partial class Africa : Form
    {
        ...
        private void button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //and then I add it to the Datagridview with the .DataSource command. With the select Id statement which is in my SQL-class it will get me my ID since I need it to get
                ...
                CountryNameHelp.continentname = "Africa";
                ShowContinentInfo showContinentInfo = new ShowContinentInfo();
                showContinentInfo.cbContinents.SelectedItem = "Afrika";
        ...
        private void btnBackToContinents_Click(object sender, EventArgs e)
        {
            try
            {
                //here I get to another Form, in this case to my start Form
                this.Visible = false; 
