    ...
    public partial class Asia : Form
    {
        ...
        private void button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //and then I add it to the Datagridview with the .DataSource command. With the select Id statement which obviously is in my SQL-class it will get me my ID since I need it to get
                ...
                CountryNameHelp.continentname = "Asia";
                ShowContinentInfo showContinentInfo = new ShowContinentInfo();
                showContinentInfo.cbContinents.SelectedItem = "Asien";
        ...
        private void Asia_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //So I just use my select statement of my SQL class to get infos of Australia, then I will get the name of the countries I have here and make buttons
                ...
                while (SQL_Communication.dr.Read())
                {
                    for (int i = 1; i < 2; i++)
                    {
                        ...
                        flp_Asia.Controls.Add(b); //here I add the button to my FlowLayoutPanel which I have manually created
                    }
                }
                SQL_Communication.conn.Close();
            }
