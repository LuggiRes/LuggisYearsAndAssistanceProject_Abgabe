    ...
    public partial class Europe : Form
    {
        ...
        private void button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //and then I add it to the Datagridview with the .DataSource command. With the select Id statement which obv. is in the SQL-Class it will get me my ID since I need it to get
                ...
                CountryNameHelp.continentname = "Europe";
                ShowContinentInfo showContinentInfo = new ShowContinentInfo();
                showContinentInfo.cbContinents.SelectedItem = "Europa";
        ...
        private void Europe_Load(object sender, EventArgs e)
        {
            try
            {
                //Here I select the Name of the countries and make it the name of our button with help of the datareader command
                //So I just use my select statement which is in my SQL class to get infos of Europe, then I will get the name of the countries I have here and make buttons
                ...
                while (SQL_Communication.dr.Read())
                {
                    for (int i = 1; i < 2; i++)
                    {
                        ...
                        flp_Europe.Controls.Add(b); //here I add the button to my FlowLayoutPanel which I have manually created
                    }
                }
                SQL_Communication.conn.Close();
            }
